/***************************************************************************/
/* Query to Refresh the ALL eanpord Database Tables					       */
...
/* THIS SCRIPT WORKS WITH Microsoft SQL 2008, 2008 R2 and 2012 - any engine*/
...
/***************************************************************************/
CREATE PROCEDURE spActivePropertyList @fromFile nvarchar(1024), @formatFile nvarchar(1024)
SET ANSI_WARNINGS OFF
MERGE activepropertylist AS Target
USING (SELECT * FROM OPENROWSET(BULK @fromFile,
	  FORMATFILE=@formatFile, FIRSTROW = 2) AS BCP) AS Source
